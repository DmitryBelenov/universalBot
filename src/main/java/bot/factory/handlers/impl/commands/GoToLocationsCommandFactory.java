...
public class GoToLocationsCommandFactory implements CommandFactory {

    private Update update;

    public GoToLocationsCommandFactory(Update update) {
        this.update = update;
    }

    @Override
    public Command getFactory() {
        return new GoToLocationsCommand(update);
    }
}
